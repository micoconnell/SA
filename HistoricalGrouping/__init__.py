...
def main(name: str) -> str:
    ...
    blob_client1 = container_client.get_blob_client("Historical1.csv")
    blob_client2 = container_client.get_blob_client("Historical2.csv")
    blob_client3 = container_client.get_blob_client("Historical3.csv")
    blob_client4 = container_client.get_blob_client("Historical4.csv")
    blob_client5 = container_client.get_blob_client("Historical5.csv")
    blob_client6 = container_client.get_blob_client("Historical6.csv")
    blob_client7 = container_client.get_blob_client("Historical7.csv")
    blob_client8 = container_client.get_blob_client("Historical8.csv")
    blob_client9 = container_client.get_blob_client("Historical9.csv")
    blob_client10 = container_client.get_blob_client("Historical10.csv")
    blob_client11 = container_client.get_blob_client("Historical11.csv")
    ...
    dfName11 = dfName11.set_index(['Date'],drop=True)

    def process_dataframe(df):
        def get_last_hour_date_str():
            calgary_tz = pytz.timezone('America/Edmonton')
            last_hour = datetime.now(calgary_tz) - timedelta(hours=1)
        ...
        last_hour = get_last_hour_date_str()
    ...
    blob_client = container_client.get_blob_client("supplyhistorical.csv")
