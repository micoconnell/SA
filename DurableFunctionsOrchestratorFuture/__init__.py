...
def orchestrator_function(context: df.DurableOrchestrationContext):
    ...
    column_apis = [
        [80, 79, 78, 322680, 322669, "Future1.csv"],
        [293674, 322687, 293675, 228, "Future2.csv"],
        [84, 322665, 294451, 294452, 294427, "Future3.csv"],
        [294428, 294418, 294417, "Future4.csv"],
        [294442, 294441, "Future5.csv"],
        [226, 225, 86, 85, 322684, "Future6.csv"],
        [87, 23695, 322677, 23694, "Future7.csv"],
        [224, 350464, 350466, 350465, 350463, "Future8.csv"],
        [337425, 337426, "Future9.csv"]
    ]
